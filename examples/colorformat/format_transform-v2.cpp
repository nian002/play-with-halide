...
#include "mg_macro.h"
#include "math/vec.h"
#include "scope/meg_scope.h"
#include "log/meg_log.h"
...
void FormatTransform::rgb2bgr(const unsigned char* __restrict__ src, unsigned char* __restrict__ dst, int image_width, int image_height) {
    ...
    mghum_log("FormatTransform::rgb2bgr without neon time(msec): %f", timer.GetMsecs() - normalBeginTime);
#else
    float neonBeginTime = (float)timer.GetMsecs();
    ...
    mghum_log("FormatTransform::rgb2bgr with neon time(msec): %f  width and height %d x %d ", timer.GetMsecs() - neonBeginTime, image_width, image_height);
#endif
}
void FormatTransform::rgb2rgba(const unsigned char* __restrict__ src, unsigned char* __restrict__ dst, int image_width, int image_height) {
    ...
    mghum_log("FormatTransform::rgb2rgba without neon time(msec): %f", timer.GetMsecs() - normalBeginTime);
    ...
    mghum_log("FormatTransform::rgb2rgba with neon time(msec): %f  width and height %d x %d ", timer.GetMsecs() - neonBeginTime, image_width, image_height);
#endif
}
void FormatTransform::rgb2yuvnv12(const unsigned char* __restrict__ src, unsigned char* __restrict__ dst, int image_width, int image_height){
    ...
    mghum_log("FormatTransform::rgb2yuvnv12 without neon time(msec): %f", timer.GetMsecs() - normalBeginTime);
    ...
    delete[](tempuv);
    mghum_log("FormatTransform::rgb2yuvnv12 with neon time(msec): %f  width and height %d x %d ", timer.GetMsecs() - neonBeginTime, image_width, image_height);
#endif
}
void FormatTransform::rgb2yuvnv21(const unsigned char* __restrict__ src, unsigned char* __restrict__ dst, int image_width, int image_height){
    ...
    mghum_log("FormatTransform::rgb2yuvnv21 without neon time(msec): %f", timer.GetMsecs() - normalBeginTime);
    ...
    delete[](tempuv);
    mghum_log("FormatTransform::rgb2yuvnv21 with neon time(msec): %f  width and height %d x %d ", timer.GetMsecs() - neonBeginTime, image_width, image_height);
#endif
}
void FormatTransform::rgb2fullyuv(const unsigned char* __restrict__ src, unsigned char* __restrict__ dst, int image_width, int image_height){
    ...
    mghum_log("FormatTransform::rgb2fullyuv without neon time(msec): %f", timer.GetMsecs() - normalBeginTime);
    ...
    mghum_log("FormatTransform::rgb2fullyuv with neon time(msec): %f  width and height %d x %d ", timer.GetMsecs() - neonBeginTime, image_width, image_height);
#endif
}
...
void FormatTransform::rgba2rgb(const unsigned char* __restrict__ src, unsigned char* __restrict__ dst, int image_width,  int image_height){
    ...
    mghum_log("FormatTransform::rgba2rgb without neon time(msec): %f", timer.GetMsecs() - normalBeginTime);
    ...
    mghum_log("FormatTransform::rgba2rgb with neon time(msec): %f  width and height %d x %d ", timer.GetMsecs() - neonBeginTime, image_width, image_height);
#endif
}
void FormatTransform::rgba2bgr(const unsigned char* __restrict__ src, unsigned char* __restrict__ dst, int image_width, int image_height) {
    ...
    mghum_log("FormatTransform::rgba2bgr without neon time(msec): %f", timer.GetMsecs() - normalBeginTime);
    ...
    mghum_log("FormatTransform::rgba2bgr with neon time(msec): %f  width and height %d x %d ", timer.GetMsecs() - neonBeginTime, image_width, image_height);
#endif
}
void FormatTransform::rgba2yuvnv12(const unsigned char* __restrict__ src, unsigned char* __restrict__ dst, int image_width, int image_height) {
    ...
    mghum_log("FormatTransform::rgba2yuvnv12 without neon time(msec): %f", timer.GetMsecs() - normalBeginTime);
    ...
    delete[](tempuv);
    mghum_log("FormatTransform::rgba2yuvnv12 with neon time(msec): %f  width and height %d x %d ", timer.GetMsecs() - neonBeginTime, image_width, image_height);
#endif
}
void FormatTransform::rgba2yuvnv21(const unsigned char* __restrict__ src, unsigned char* __restrict__ dst, int image_width, int image_height) {
    ...
    mghum_log("FormatTransform::rgba2yuvnv21 without neon time(msec): %f", timer.GetMsecs() - normalBeginTime);
    ...
    delete[](tempuv);
    mghum_log("FormatTransform::rgba2yuvnv21 with neon time(msec): %f width and height %d x %d ", timer.GetMsecs() - neonBeginTime, image_width, image_height);
#endif
}
void FormatTransform::rgba2fullyuv(const unsigned char* __restrict__ src, unsigned char* __restrict__ dst, int image_width, int image_height){
    ...
    mghum_log("FormatTransform::rgba2fullyuv without neon time(msec): %f", timer.GetMsecs() - normalBeginTime);
...
void FormatTransform::bgr2rgb(const unsigned char* __restrict__ src, unsigned char* __restrict__ dst, int image_width, int image_height) {
    ...
    mghum_log("FormatTransform::bgr2rgb without neon time(msec): %f", timer.GetMsecs() - normalBeginTime);
    ...
    mghum_log("FormatTransform::bgr2rgb with neon time(msec): %f  width and height %d x %d ", timer.GetMsecs() - neonBeginTime, image_width, image_height);
#endif
}
void FormatTransform::bgr2rgba(const unsigned char* __restrict__ src, unsigned char* __restrict__ dst, int image_width, int image_height) {
    ...
    mghum_log("FormatTransform::bgr2rgba without neon time(msec): %f", timer.GetMsecs() - normalBeginTime);
    ...
    mghum_log("FormatTransform::bgr2rgba with neon time(msec): %f  width and height %d x %d ", timer.GetMsecs() - neonBeginTime, image_width, image_height);
#endif
}
void FormatTransform::bgr2yuvnv12(const unsigned char* __restrict__ src, unsigned char* __restrict__ dst, int image_width, int image_height) {
    ...
    mghum_log("FormatTransform::bgr2yuvnv12 without neon time(msec): %f", timer.GetMsecs() - normalBeginTime);
    ...
    delete[](tempuv);
    mghum_log("FormatTransform::bgr2yuvnv12 with neon time(msec): %f  width and height %d x %d ", timer.GetMsecs() - neonBeginTime, image_width, image_height);
...
void FormatTransform::bgr2yuvnv21(const unsigned char* __restrict__ src, unsigned char* __restrict__ dst, int image_width, int image_height) {
    ...
    mghum_log("FormatTransform::bgr2yuvnv21 without neon time(msec): %f", timer.GetMsecs() - normalBeginTime);
    ...
    delete[](tempuv);
    mghum_log("FormatTransform::bgr2yuvnv21 with neon time(msec): %f  width and height %d x %d ", timer.GetMsecs() - neonBeginTime, image_width, image_height);
#endif
}
void FormatTransform::bgr2fullyuv(const unsigned char* __restrict__ src, unsigned char* __restrict__ dst, int image_width, int image_height){
    ...
    mghum_log("FormatTransform::bgr2fullyuv without neon time(msec): %f", timer.GetMsecs() - normalBeginTime);
    ...
    mghum_log("FormatTransform::bgr2fullyuv with neon time(msec): %f  width and height %d x %d ", timer.GetMsecs() - neonBeginTime, image_width, image_height);
#endif
}
...
void FormatTransform::yuvnv122rgb(const unsigned char* __restrict__ src, unsigned char* __restrict__ dst, int image_width, int image_height){
    ...
    mghum_log("FormatTransform::yuvnv122rgb without neon time(msec): %f", timer.GetMsecs() - normalBeginTime);
    ...
    mghum_log("FormatTransform::yuvnv122rgb with neon time(msec): %f  width and height %d x %d ", timer.GetMsecs() - neonBeginTime, image_width, image_height);
#endif
}
void FormatTransform::yuvnv122rgba(const unsigned char* __restrict__ src, unsigned char* __restrict__ dst, int image_width, int image_height){
    ...
    mghum_log("FormatTransform::yuvnv122rgba without neon time(msec): %f", timer.GetMsecs() - normalBeginTime);
    ...
    mghum_log("FormatTransform::yuvnv122rgba with neon time(msec): %f  width and height %d x %d ", timer.GetMsecs() - neonBeginTime, image_width, image_height);
...
void FormatTransform::yuvnv122bgr(const unsigned char* __restrict__ src, unsigned char* __restrict__ dst, int image_width, int image_height){
    ...
    mghum_log("FormatTransform::yuvnv122bgr without neon time(msec): %f", timer.GetMsecs() - normalBeginTime);
    ...
    mghum_log("FormatTransform::yuvnv122bgr with neon time(msec): %f  width and height %d x %d ", timer.GetMsecs() - neonBeginTime, image_width, image_height);
#endif
}
...
void FormatTransform::yuvnv122fullyuv(const unsigned char* __restrict__ src, unsigned char* __restrict__ dst, int image_width, int image_height){
    ...
    mghum_log("FormatTransform::yuvnv122fullyuv without neon time(msec): %f", timer.GetMsecs() - normalBeginTime);
    ...
    for (int i = 0; i < image_height; ++i) {
        for (int j = 0; j < quotient; ++j) {
            ...
            //load nv21 data into src register from memory
            yuv_register.val[0] = vld1q_u8(src + i * image_width + 16 *j);
            temp_uv_register = vld2_u8(uv_src + i / 2 * image_width + 16 * j);

            u_register = vzip_u8(temp_uv_register.val[0], temp_uv_register.val[0]);
            v_register = vzip_u8(temp_uv_register.val[1], temp_uv_register.val[1]);

            yuv_register.val[1] = vcombine_u8(u_register.val[0], u_register.val[1]);
            yuv_register.val[2] = vcombine_u8(v_register.val[0], v_register.val[1]);
    ...
    mghum_log("FormatTransform::yuvnv122fullyuv with neon time(msec): %f  width and height %d x %d ", timer.GetMsecs() - neonBeginTime, image_width, image_height);
#endif
}
...
void FormatTransform::yuvnv212rgb(const unsigned char* __restrict__ src, unsigned char* __restrict__ dst, int image_width, int image_height) {
    ...
    mghum_log("FormatTransform::yuvnv212rgb without neon time(msec): %f", timer.GetMsecs() - normalBeginTime);
    ...
    mghum_log("FormatTransform::yuvnv212rgb with neon time(msec): %f  width and height %d x %d ", timer.GetMsecs() - neonBeginTime, image_width, image_height);
#endif
}
void FormatTransform::yuvnv212rgba(const unsigned char* __restrict__ src, unsigned char* __restrict__ dst, int image_width, int image_height) {
    ...
    mghum_log("FormatTransform::yuvnv212rgba without neon time(msec): %f", timer.GetMsecs() - normalBeginTime);
    ...
    mghum_log("FormatTransform::yuvnv212rgba with neon time(msec): %f  width and height %d x %d ", timer.GetMsecs() - neonBeginTime, image_width, image_height);
#endif
}
void FormatTransform::yuvnv212bgr(const unsigned char* __restrict__ src, unsigned char* __restrict__ dst, int image_width, int image_height) {
    ...
    mghum_log("FormatTransform::yuvnv212bgr without neon time(msec): %f", timer.GetMsecs() - normalBeginTime);
    ...
    mghum_log("FormatTransform::yuvnv212bgr with neon time(msec): %f  width and height %d x %d ", timer.GetMsecs() - neonBeginTime, image_width, image_height);
#endif
}
...
void FormatTransform::yuvnv212fullyuv(const unsigned char * __restrict__ src, unsigned char * __restrict__ dst, int image_width, int image_height){
    ...
    mghum_log("FormatTransform::yuvnv212fullyuv without neon time(msec): %f", timer.GetMsecs() - normalBeginTime);
    ...
    for (int i = 0; i < image_height; ++i) {
        for (int j = 0; j < quotient; ++j) {
            ...
            u_register = vzip_u8(temp_uv_register.val[1], temp_uv_register.val[1]);
            v_register = vzip_u8(temp_uv_register.val[0], temp_uv_register.val[0]);
    ...
    mghum_log("FormatTransform::yuvnv212fullyuv with neon time(msec): %f  width and height %d x %d ", timer.GetMsecs() - neonBeginTime, image_width, image_height);

#endif
}


void FormatTransform::fullyuv2rgb(const unsigned char* __restrict__ src, unsigned char* __restrict__ dst, int image_width, int image_height){
    Timer timer;
#ifndef __ARM_NEON__
    float normalBeginTime = (float)timer.GetMsecs();
    for (int i = 0; i < image_height; i++) {
        for (int j = 0; j < image_width; j++) {
            int index = i * image_width + j;
            int y = (int) src[index * 3+ 0];
            int u = (int) src[index * 3+ 1];
            int v = (int) src[index * 3+ 2];
    ...
    mghum_log("FormatTransform::fullyuv2rgb without neon time(msec): %f", timer.GetMsecs() - normalBeginTime);
    ...
    for (int i = 0; i < image_height; ++i) {
        for (int j = 0; j < quotient; ++j) {
            ...
            yuv_register = vld3_u8(src + (i * image_width + 8 *j) * 3);
        ...
        for (int j = 0; j < remainder; ++j) {
            int yuv_index = (i * image_width + 8 * quotient + j) * 3;
            int y = src[yuv_index + 0];
            int u = src[yuv_index + 1];
            int v = src[yuv_index + 2];
    ...
    mghum_log("FormatTransform::fullyuv2rgb with neon time(msec): %f  width and height %d x %d ", timer.GetMsecs() - neonBeginTime, image_width, image_height);
#endif
}

void FormatTransform::fullyuv2bgr(const unsigned char* __restrict__ src, unsigned char* __restrict__ dst, int image_width, int image_height){
    Timer timer;
#ifndef __ARM_NEON__
    float normalBeginTime = (float)timer.GetMsecs();
    for (int i = 0; i < image_height; i++) {
    ...
    mghum_log("FormatTransform::fullyuv2bgr without neon time(msec): %f", timer.GetMsecs() - normalBeginTime);
    ...
    for (int i = 0; i < image_height; ++i) {
        for (int j = 0; j < quotient; ++j) {
            ...
            rgb_register.val[2] = vqmovn_u16(vcombine_u16(vqmovn_u32(vreinterpretq_u32_s32(low_r)), vqmovn_u32(vreinterpretq_u32_s32(high_r))));
            rgb_register.val[1] = vqmovn_u16(vcombine_u16(vqmovn_u32(vreinterpretq_u32_s32(low_g)), vqmovn_u32(vreinterpretq_u32_s32(high_g))));
            rgb_register.val[0] = vqmovn_u16(vcombine_u16(vqmovn_u32(vreinterpretq_u32_s32(low_b)), vqmovn_u32(vreinterpretq_u32_s32(high_b))));
            vst3_u8(dst, rgb_register);
    ...
    mghum_log("FormatTransform::fullyuv2bgr with neon time(msec): %f  width and height %d x %d ", timer.GetMsecs() - neonBeginTime, image_width, image_height);
#endif
}



void FormatTransform::fullyuv2rgba(const unsigned char* __restrict__ src, unsigned char* __restrict__ dst, int image_width, int image_height){
    Timer timer;
#ifndef __ARM_NEON__
    float normalBeginTime = (float)timer.GetMsecs();
    for (int i = 0; i < image_height; i++) {
    ...
    mghum_log("FormatTransform::fullyuv2rgba without neon time(msec): %f", timer.GetMsecs() - normalBeginTime);
    ...
    mghum_log("FormatTransform::fullyuv2rgba with neon time(msec): %f  width and height %d x %d ", timer.GetMsecs() - neonBeginTime, image_width, image_height);

#endif
}

void FormatTransform::fullyuv2yuvnv12(const unsigned char * __restrict__ src, unsigned char * __restrict__ dst, int image_width, int image_height){
    Timer timer;
#ifndef __ARM_NEON__
    float normalBeginTime = (float)timer.GetMsecs();
    int nv21_len = image_width * image_height;
    ...
    mghum_log("FormatTransform::fullyuv2yuvnv12 without neon time(msec): %f", timer.GetMsecs() - normalBeginTime);
    ...
    for (int i = 0; i < image_height; ++i)
    {
        if (i % 2 == 1)
        {
            for (int j = 0; j < count; ++j)
            {
                ...
                uv_register.val[0] = vtbl2_u8(u_register, index_register);
                uv_register.val[1] = vtbl2_u8(v_register, index_register);
    ...
    mghum_log("FormatTransform::fullyuv2yuvnv12 with neon time(msec): %f  width and height %d x %d ", timer.GetMsecs() - neonBeginTime, image_width, image_height);
#endif
}
...
void FormatTransform::fullyuv2yuvnv21(const unsigned char * __restrict__ src, unsigned char * __restrict__ dst, int image_width, int image_height){
    ...
    mghum_log("FormatTransform::fullyuv2yuvnv21 without neon time(msec): %f", timer.GetMsecs() - normalBeginTime);
    ...
    mghum_log("FormatTransform::fullyuv2yuvnv21 with neon time(msec): %f  width and height %d x %d ", timer.GetMsecs() - neonBeginTime, image_width, image_height);
#endif
}
...
void FormatTransform::nv212resizedbgr(const unsigned char* src, int src_width, int src_height, unsigned char* dst, int dst_width, int dst_height) {
    doF(i, dst_height)
        doF(j, dst_width) {
            ...
            int ii = clamp(int(floor(((float) i + 0.5) / dst_height * src_height)), 0, src_height - 1);
            ...
            result.val[2] = vqadd_u8(vshr_n_u8(vmul_u8(vdup_n_u8((uint8_t)359),uv_.val[0]),8),vdup_n_u8((uint8_t)0));
            result.val[1] = vqadd_u8(vsub_u8(y_,vshr_n_u8(vadd_u8(vmul_u8(vdup_n_u8((uint8_t)88),uv_.val[1]),vmul_u8(vdup_n_u8((uint8_t)183),uv_.val[0])),8)),vdup_n_u8(0));
            result.val[0] = vqadd_u8(vadd_u8(y_,vshr_n_u8(vmul_u8(vdup_n_u8((uint8_t)454),vsub_u8(uv_.val[1],temp1)),8)),vdup_n_u8((uint8_t)0));
